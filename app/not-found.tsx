    ...
    <main className="editorial-grid min-h-screen">
      <div className="flex flex-col justify-center min-h-[80vh] py-20">
        <div className={`opacity-0 ${isVisible ? 'animate-fade-in' : ''}`}>
          ...
          <h1 className="text-headline text-nearBlack mb-6 max-w-[16ch]">
            This page wandered off
          </h1>

          <p className="text-body-lg text-muted max-w-[36ch] mb-8">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-body text-accent font-medium
