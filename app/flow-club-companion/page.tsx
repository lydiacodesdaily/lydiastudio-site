...
export default function FlowClubCompanion() {
  ...
  return (
    <main className="editorial-grid min-h-screen pb-20">
      {/* Hero Section */}
      <header className={`relative pt-20 md:pt-32 pb-12 opacity-0 ${isVisible ? 'animate-fade-up' : ''}`}>
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-caption text-muted hover:text-matcha-accent transition-colors mb-8"
        >
        ...
        <h1 className="text-display font-serif text-nearBlack mb-6 max-w-[18ch]">
          Flow Club Companion
        </h1>
        <p className="text-subhead text-muted font-light max-w-[38ch]">
          Gentle audio cues and time awareness for Flow Club sessions.
        </p>
      </header>

      {/* TL;DR Quick Start - Most important for ND users */}
      <section className={`py-8 opacity-0 ${isVisible ? 'animate-fade-up animate-delay-100' : ''}`}>
        <div className="bg-matcha-50 border border-matcha-200 rounded-lg p-6 md:p-8">
          <p className="text-caption uppercase tracking-widest text-matcha-700 mb-4">Quick Start</p>
          <ol className="space-y-3 text-body text-nearBlack">
            ...
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-matcha-accent text-white text-sm flex items-center justify-center">2</span>
              <span>Open a Flow Club session at <a href="https://in.flow.club" target="_blank" rel="noopener noreferrer" className="text-matcha-accent hover:underline">in.flow.club</a></span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-matcha-accent text-white text-sm flex items-center justify-center">3</span>
              <span><strong>Refresh the page once</strong> — you should hear a tick sound</span>
            </li>
          </ol>
          <p className="text-caption text-matcha-700 mt-4">
      ...
      <nav className={`py-8 opacity-0 ${isVisible ? 'animate-fade-up animate-delay-200' : ''}`}>
        <p className="text-caption uppercase tracking-widest text-stone mb-4">Jump to section</p>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <p className="text-caption text-matcha-accent font-medium mb-2">Setup</p>
            <ul className="space-y-1.5 text-body">
              <li>
                <a href="#install" className="text-muted hover:text-matcha-accent transition-colors">
                  Install the Extension
                </a>
              </li>
              <li>
                <a href="#first-session" className="text-muted hover:text-matcha-accent transition-colors">
                  Your First Session
                </a>
              </li>
            </ul>
          ...
          <div>
            <p className="text-caption text-matcha-accent font-medium mb-2">Reference (read later)</p>
            <ul className="space-y-1.5 text-body">
              <li>
                <a href="#settings" className="text-muted hover:text-matcha-accent transition-colors">
                  All Settings Explained
                </a>
              </li>
              <li>
                <a href="#tasks" className="text-muted hover:text-matcha-accent transition-colors">
                  Tasks Tab
                </a>
              </li>
              <li>
                <a href="#troubleshooting" className="text-muted hover:text-matcha-accent transition-colors">
                  Troubleshooting
                </a>
              </li>
            </ul>
      ...
      {/* === SETUP SECTION === */}
      <div className="py-4">
        <p className="text-overline uppercase text-matcha-accent font-medium tracking-widest">
          Setup
        </p>
      </div>
      ...
      <section id="first-session" className="py-8">
        <h2 className="text-headline font-serif text-nearBlack mb-6">Your First Session</h2>
      ...
      {/* Settings Explained - Collapsible feel with summary first */}
      <section id="settings" className="py-8">
        <h2 className="text-headline font-serif text-nearBlack mb-4">All Settings Explained</h2>
        <p className="text-body text-muted mb-8">
          Click the extension icon to open settings. Here's what each one does:
        </p>

        <div className="space-y-4">
          <details className="group bg-white/60 rounded-lg border border-cream-300">
            <summary className="p-5 cursor-pointer list-none flex justify-between items-center">
              <span className="text-body-lg font-serif text-nearBlack">Audio On</span>
          ...
          <details className="group bg-white/60 rounded-lg border border-cream-300">
            <summary className="p-5 cursor-pointer list-none flex justify-between items-center">
              <span className="text-body-lg font-serif text-nearBlack">Tick sound</span>
              <span className="text-muted group-open:rotate-180 transition-transform">▼</span>
            </summary>
            <div className="px-5 pb-5 text-body text-muted">
          ...
          <details className="group bg-white/60 rounded-lg border border-cream-300">
            <summary className="p-5 cursor-pointer list-none flex justify-between items-center">
              <span className="text-body-lg font-serif text-nearBlack">Voice announcements</span>
              <span className="text-muted group-open:rotate-180 transition-transform">▼</span>
            </summary>
            <div className="px-5 pb-5 text-body text-muted">
          ...
          <details className="group bg-white/60 rounded-lg border border-cream-300">
            <summary className="p-5 cursor-pointer list-none flex justify-between items-center">
              <span className="text-body-lg font-serif text-nearBlack">Mute during breaks</span>
              <span className="text-muted group-open:rotate-180 transition-transform">▼</span>
            </summary>
            <div className="px-5 pb-5 text-body text-muted">
              <p className="mb-2">Automatically silences sounds during breaks.</p>
              <p className="text-caption text-matcha-accent font-medium">Highly recommended.</p>
            </div>
          </details>

          <details className="group bg-white/60 rounded-lg border border-cream-300">
            <summary className="p-5 cursor-pointer list-none flex justify-between items-center">
              <span className="text-body-lg font-serif text-nearBlack">Seconds countdown</span>
              <span className="text-muted group-open:rotate-180 transition-transform">▼</span>
            </summary>
            <div className="px-5 pb-5 text-body text-muted">
          ...
          <details className="group bg-white/60 rounded-lg border border-cream-300">
            <summary className="p-5 cursor-pointer list-none flex justify-between items-center">
              <span className="text-body-lg font-serif text-nearBlack">Volume controls</span>
              <span className="text-muted group-open:rotate-180 transition-transform">▼</span>
            </summary>
            <div className="px-5 pb-5 text-body text-muted">
      ...
      <section id="tasks" className="py-8">
        <h2 className="text-headline font-serif text-nearBlack mb-4">Tasks Tab</h2>
        <p className="text-body text-muted mb-6">
          Optional feature for gentle structure. Good for morning routines, reducing decision fatigue, or ritual-based focus.
        </p>

        <div className="bg-white/60 rounded-lg border border-cream-300 p-6">
          <p className="text-body-lg font-serif text-nearBlack mb-4">Two-way task syncing</p>
      ...
      <section id="troubleshooting" className="py-8">
        <h2 className="text-headline font-serif text-nearBlack mb-6">Troubleshooting</h2>

        <div className="bg-white/60 rounded-lg border border-cream-300 p-6 mb-6">
          ...
          <ul className="space-y-2 text-body text-muted">
            ...
            <li className="flex items-center gap-2">
              <span className="text-matcha-accent">□</span> Session timer is running
            </li>
            <li className="flex items-center gap-2">
              <span className="text-matcha-accent">□</span> Audio is on in extension settings
            </li>
            <li className="flex items-center gap-2">
              <span className="text-matcha-accent">□</span> Browser tab isn't muted
            </li>
          </ul>
        </div>
        ...
        <p className="text-body text-muted mt-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-matcha-accent hover:underline"
          >
            Reach out here →
          </a>
        </p>
      ...
      {/* Final Note - Shortened */}
      <section className="py-8">
        <h2 className="text-headline font-serif text-nearBlack mb-6">A note on finding your setup</h2>
